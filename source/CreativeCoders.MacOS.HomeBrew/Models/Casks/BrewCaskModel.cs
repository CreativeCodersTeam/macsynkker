...
public class BrewCaskModel
{
    ...
    [JsonPropertyName("full_token")] public string? FullToken { get; set; }

    /// <summary>Gets or sets the list of old tokens.</summary>
    [JsonPropertyName("old_tokens")] public string[]? OldTokens { get; set; }
    ...
    [JsonPropertyName("url_specs")] public BrewUrlSpecsModel? UrlSpecs { get; set; }
    ...
    [JsonPropertyName("installed_time")] public long? InstalledTime { get; set; }

    /// <summary>Gets or sets the bundle version (CFBundleVersion).</summary>
    [JsonPropertyName("bundle_version")] public string? BundleVersion { get; set; }

    /// <summary>Gets or sets the bundle short version (CFBundleShortVersionString).</summary>
    [JsonPropertyName("bundle_short_version")] public string? BundleShortVersion { get; set; }
    ...
    [JsonPropertyName("artifacts")] public BrewArtifactModel[]? Artifacts { get; set; }
    ...
    [JsonPropertyName("auto_updates")] public bool? AutoUpdates { get; set; }
