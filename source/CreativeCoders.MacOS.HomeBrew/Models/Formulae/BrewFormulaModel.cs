...
public class BrewFormulaModel
{
    ...
    [JsonPropertyName("versioned_formulae")]
    public string[]? VersionedFormulae { get; set; }
    ...
    public BrewVersionsModel? Versions { get; set; }

    /// <summary>Gets or sets the URLs used to fetch sources/binaries.</summary>
    [JsonPropertyName("urls")]
    public BrewUrlsModel? Urls { get; set; }
    ...
    public int? VersionScheme { get; set; }
    ...
    [JsonPropertyName("bottle")]
    public BrewBottleModel? Bottle { get; set; }

    /// <summary>Gets or sets a condition when a bottle may be poured only if a command returns true.</summary>
    [JsonPropertyName("pour_bottle_only_if")]
    public string? PourBottleOnlyIf { get; set; }

    /// <summary>Gets or sets a value indicating whether the formula is keg-only.</summary>
    [JsonPropertyName("keg_only")]
    public bool? KegOnly { get; set; }

    /// <summary>Gets or sets the reason for being keg-only, if any.</summary>
    [JsonPropertyName("keg_only_reason")]
    public IDictionary<string, string>? KegOnlyReason { get; set; }
    ...
    [JsonPropertyName("test_dependencies")]
    public string[]? TestDependencies { get; set; }

    /// <summary>Gets or sets recommended dependencies (optional set).</summary>
    [JsonPropertyName("recommended_dependencies")]
    public string[]? RecommendedDependencies { get; set; }
    ...
    [JsonPropertyName("uses_from_macos")]
    public object[]? UsesFromMacos { get; set; }

    /// <summary>Gets or sets version bounds for macOS uses, if present.</summary>
    [JsonPropertyName("uses_from_macos_bounds")]
    public object[]? UsesFromMacosBounds { get; set; }

    /// <summary>Gets or sets additional requirements if any. Represented as strings for simplicity.</summary>
    [JsonPropertyName("requirements")]
    public IDictionary<string, object?>[]? Requirements { get; set; }
    ...
    [JsonPropertyName("conflicts_with_reasons")]
    public string[]? ConflictsWithReasons { get; set; }

    /// <summary>Gets or sets files to be linked overwriting conflicts.</summary>
    [JsonPropertyName("link_overwrite")]
    public string[]? LinkOverwrite { get; set; }
    ...
    public BrewInstalledFormulaModel[]? Installed { get; set; }

    /// <summary>Gets or sets the currently linked keg version if any.</summary>
    [JsonPropertyName("linked_keg")]
    public string? LinkedKeg { get; set; }
    ...
    [JsonPropertyName("post_install_defined")]
    public bool? PostInstallDefined { get; set; }
